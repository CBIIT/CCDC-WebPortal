            ...
            <NavContainer>
                ...
                <MobileUlContainer ref={mobileMenuSelection} id="mobile-navigation" className="mobile-navigation" data-visible={mobileMenuData}>
                  ...
                  <MobileSubUl data-visible={mobileStudiesMenuData}>
                    ...
                    <MobileLiSection><a href="https://d2xnga7irezzit.cloudfront.net/ccdc_files/digests/digest_1.5.7.zip" target="_blank" rel="noreferrer">Metadata Files</a></MobileLiSection>
                  ...
                  <MobileSubUl data-visible={mobileAboutMenuData}>
                    ...
                    <MobileLiSection><a href="/User Guide for CCDC v1.5.7.pdf" target="_blank" rel="noreferrer">User Guide (PDF)</a></MobileLiSection>
                  </MobileSubUl>
                ...
                <UlContainer id="primary-navigation" className="primary-navigation">
                  ...
                  <LiSection>
                      ...
                      <ul className="dropdown">
                          ...
                          <li><a href="https://d2xnga7irezzit.cloudfront.net/ccdc_files/digests/digest_1.5.7.zip" target="_blank" rel="noreferrer">&nbsp; &nbsp; Metadata Files</a></li>
                  ...
                  <LiSection>
                      ...
                      <ul className="dropdown">
                          ...
                          <li><a href="/User Guide for CCDC v1.5.7.pdf" target="_blank" rel="noreferrer">&nbsp; &nbsp; User Guide (PDF)</a></li>
                      </ul>
                  </LiSection>
