            ...
            <NavContainer>
                ...
                <MobileUlContainer ref={mobileMenuSelection} id="mobile-navigation" className="mobile-navigation" data-visible={mobileMenuData}>
                  ...
                  <MobileSubUl data-visible={mobileAboutMenuData}>
                    ...
                    <MobileLiSection><a href="/User Guide for CCDC v1.4.0.pdf" target="_blank" rel="noreferrer">User Guide (PDF)</a></MobileLiSection>
                  </MobileSubUl>
                </MobileUlContainer>
                <UlContainer id="primary-navigation" className="primary-navigation">
                  ...
                  <LiSection>
                      ...
                      <ul className="dropdown">
                          ...
                          <li><a href="/User Guide for CCDC v1.4.0.pdf" target="_blank" rel="noreferrer">&nbsp; &nbsp; User Guide (PDF)</a></li>
                      </ul>
                  </LiSection>
                </UlContainer>
                {
