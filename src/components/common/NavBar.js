            ...
            <NavContainer>
                ...
                <MobileUlContainer ref={mobileMenuSelection} id="mobile-navigation" className="mobile-navigation" data-visible={mobileMenuData}>
                  ...
                  <MobileSubUl data-visible={mobileStudiesMenuData}>
                    ...
                    <MobileLiSection><a href="https://d2xnga7irezzit.cloudfront.net/ccdc_files/digests/digest_1.5.9.zip" target="_blank" rel="noreferrer">Metadata Files</a></MobileLiSection>
                ...
                <UlContainer id="primary-navigation" className="primary-navigation">
                  ...
                  <LiSection>
                      ...
                      <ul className="dropdown">
                          ...
                          <li><a href="https://d2xnga7irezzit.cloudfront.net/ccdc_files/digests/digest_1.5.9.zip" target="_blank" rel="noreferrer">&nbsp; &nbsp; Metadata Files</a></li>
