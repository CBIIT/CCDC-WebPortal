            ...
            <div className="filter-sections">
              ...
              }
              {
                key === 'B' && (
                  <>
                    ...
                    <div className="b">
                      <h2 className="glossaryItemHeader">Biorepository</h2>
                      <span className="glossaryItemType">Resource Type</span>
                      <p className="glossaryItemDescription">A biorepository is a facility that acts as a library for biospecimens, allowing the biospecimens to be available for use in future research. A biospecimen may be from people, animals, or other living organisms. A biorepository will be involved in collecting, cataloguing, and storing biospecimens. The biorepository will also be involved in managing access to and distributing biospecimens to researchers. Some biorepositories store medical information associated with biospecimens.</p>
                      <br />
                    </div>
                    <div className="b">
                      <h2 className="glossaryItemHeader">Biospecimen</h2>
                      <span className="glossaryItemType">Data Content Type</span>
                      <p className="glossaryItemDescription">A sample of material, such as urine, blood, tissue, cells, DNA, RNA, or protein, from humans, animals, or plants. Biospecimens may be used for a laboratory test or stored in a biorepository to be used for research.</p>
                      <br />
                    </div>
                    <div className="b">
                      <h2 className="glossaryItemHeader">BPC</h2>
                      <span className="glossaryItemType">Resource Abbreviation</span>
                      <p className="glossaryItemDescription">The Biopathology Center</p>
                      <br />
                    </div>
                    <div className="b">
                      <h2 className="glossaryItemHeader">BTB</h2>
                      <span className="glossaryItemType">Resource Abbreviation</span>
                      <p className="glossaryItemDescription">Swedish Childhood Tumor Biobank (Barntumörbanken)</p>
                      <br />
                      <br />
                    </div>
                  </>
              ...
              }
              {
                key === 'D' && (
                  <>
                    ...
                    <div className="r">
                      <h2 className="glossaryItemHeader">Data Repository</h2>
                      <span className="glossaryItemType">Resource Type</span>
              ...
              }
              {
                key === 'N' && (
                  <>
                    <div className="n">
                      <h2 className="glossaryItemHeader">NCCB</h2>
                      <span className="glossaryItemType">Resource Abbreviation</span>
                      <p className="glossaryItemDescription">Norwegian Childhood Cancer Biobank</p>
                      <br />
                    </div>
                    <div className="n">
